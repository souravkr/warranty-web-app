...
<script src="https://kit.fontawesome.com/a86ed0bb07.js"
...
<header class="header">
	<nav class="navbar navbar-expand-lg fixed-top py-3">
		<div class="container">
			<a href="#" class="navbar-brand text-uppercase font-weight-bold">Warranty App</a>
...
<br><br><br><br><br><br>
								...
								<c:forEach var="tempProduct" items="${products}"
									...
									<tr class="alert" role="alert">
										...
										<td class="d-flex align-items-center">
											<div class="img"
												style="background-image: url(${pageContext.request.contextPath}/resources/images/${imageName[status.index]}.jpg);"></div>
											<div class="pl-3 email">
												<span>${tempProduct.name}</span> <span>${brand[status.index].name}</span>
											</div>
										</td>
									...
									<c:choose>
										...
										<c:otherwise>
											<td><a
												href="${pageContext.request.contextPath}/Invoices/${tempProduct.invoice}"
												target="_blank">View Invoice/Bill</a></td>
										</c:otherwise>
									</c:choose>
	...
	<a href="${pageContext.request.contextPath}/product/showForm"
		class="float"> <i class="fa fa-plus my-float"></i>
	</a>
	...
	<footer class="text-center text-lg-start"
		...
		<div class="container d-flex justify-content-center py-5">
			...
			</a> <a href="https://www.twitter.com/souravk229" target="_blank">
				<button type="button"
					class="btn btn-primary btn-lg btn-floating mx-2"
					style="background-color: #54456b;">
		...
		<div class="text-center text-white p-3"
			...
			© 2022 Copyright: <a class="text-white" href="https://trickspy.in/">Trickspy.in</a>
		</div>
		<!-- Copyright -->
	</footer>
	...
	<script
		src="${pageContext.request.contextPath}/resources/javascript/popper.js"></script>
	<script
	...
	<script
		src="${pageContext.request.contextPath}/resources/javascript/menu.js"></script>
